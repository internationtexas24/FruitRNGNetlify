...
export const fruitDatabase: Fruit[] = [
  ...
  { id: 'watermelon', emoji: '🍉', name: 'Watermelon', rarity: 'common', chance: 7 },
  ...
  { id: 'strawberry', emoji: '🍓', name: 'Strawberry', rarity: 'uncommon', chance: 6 },
  ...
  { id: 'pineapple', emoji: '🍍', name: 'Pineapple', rarity: 'epic', chance: 1.5 },
  { id: 'mango', emoji: '🥭', name: 'Mango', rarity: 'epic', chance: 1.3 },
  
  // Legendary fruits (0.2% total)
  { id: 'dragon-fruit', emoji: '🐉', name: 'Dragon Fruit', rarity: 'legendary', chance: 0.2 },
  
  // Additional fruits to reach 100
  { id: 'coconut', emoji: '🥥', name: 'Coconut', rarity: 'uncommon', chance: 3 },
  { id: 'avocado', emoji: '🥑', name: 'Avocado', rarity: 'rare', chance: 2 },
  { id: 'tomato', emoji: '🍅', name: 'Tomato', rarity: 'common', chance: 5 },
  { id: 'eggplant', emoji: '🍆', name: 'Eggplant', rarity: 'uncommon', chance: 2 },
  ...
  { id: 'sweet-potato', emoji: '🍠', name: 'Sweet Potato', rarity: 'uncommon', chance: 2 },
  { id: 'mushroom', emoji: '🍄', name: 'Mushroom', rarity: 'rare', chance: 1 },
  { id: 'chestnut', emoji: '🌰', name: 'Chestnut', rarity: 'uncommon', chance: 1.5 },
  { id: 'peanuts', emoji: '🥜', name: 'Peanuts', rarity: 'common', chance: 3 },
  { id: 'hot-pepper', emoji: '🌶️', name: 'Hot Pepper', rarity: 'rare', chance: 1.5 },
  { id: 'bell-pepper', emoji: '🫑', name: 'Bell Pepper', rarity: 'uncommon', chance: 2 },
  { id: 'cucumber', emoji: '🥒', name: 'Cucumber', rarity: 'common', chance: 3 },
  { id: 'broccoli', emoji: '🥦', name: 'Broccoli', rarity: 'uncommon', chance: 1.8 },
  { id: 'garlic', emoji: '🧄', name: 'Garlic', rarity: 'uncommon', chance: 1.7 },
  { id: 'onion', emoji: '🧅', name: 'Onion', rarity: 'common', chance: 4 },
  { id: 'bread', emoji: '🍞', name: 'Bread', rarity: 'common', chance: 5 },
  { id: 'croissant', emoji: '🥐', name: 'Croissant', rarity: 'uncommon', chance: 2.5 },
  ...
  { id: 'chicken', emoji: '🍗', name: 'Chicken', rarity: 'uncommon', chance: 3.5 },
  ...
  { id: 'hamburger', emoji: '🍔', name: 'Hamburger', rarity: 'uncommon', chance: 3 },
  { id: 'pizza', emoji: '🍕', name: 'Pizza', rarity: 'rare', chance: 2 },
  { id: 'sandwich', emoji: '🥪', name: 'Sandwich', rarity: 'common', chance: 4 },
  { id: 'taco', emoji: '🌮', name: 'Taco', rarity: 'uncommon', chance: 2.8 },
  { id: 'burrito', emoji: '🌯', name: 'Burrito', rarity: 'uncommon', chance: 2.5 },
  ...
  { id: 'ice-cream', emoji: '🍦', name: 'Ice Cream', rarity: 'uncommon', chance: 2.8 },
  { id: 'cake', emoji: '🍰', name: 'Cake', rarity: 'rare', chance: 1.5 },
  { id: 'pie', emoji: '🥧', name: 'Pie', rarity: 'rare', chance: 1.3 },
  { id: 'chocolate', emoji: '🍫', name: 'Chocolate', rarity: 'uncommon', chance: 3.2 },
  { id: 'candy', emoji: '🍬', name: 'Candy', rarity: 'common', chance: 4 },
  { id: 'lollipop', emoji: '🍭', name: 'Lollipop', rarity: 'common', chance: 3.5 },
  ...
  { id: 'coffee', emoji: '☕', name: 'Coffee', rarity: 'uncommon', chance: 3.5 },
  ...
  { id: 'cocktail', emoji: '🍸', name: 'Cocktail', rarity: 'epic', chance: 0.7 },
  ...
  { id: 'seaweed', emoji: '🌿', name: 'Seaweed', rarity: 'uncommon', chance: 2 },
  { id: 'kelp', emoji: '🌾', name: 'Kelp', rarity: 'rare', chance: 0.8 },
  { id: 'algae', emoji: '🦠', name: 'Algae', rarity: 'common', chance: 3 },
  { id: 'plankton', emoji: '🦠', name: 'Plankton', rarity: 'uncommon', chance: 1.5 },
  { id: 'coral', emoji: '🪸', name: 'Coral', rarity: 'epic', chance: 0.2 },
  { id: 'pearl', emoji: '🫧', name: 'Pearl', rarity: 'legendary', chance: 0.05 },
  { id: 'gold-apple', emoji: '🍎', name: 'Golden Apple', rarity: 'legendary', chance: 0.03 },
  { id: 'diamond-fruit', emoji: '💎', name: 'Diamond Fruit', rarity: 'legendary', chance: 0.01 },
  { id: 'star-fruit', emoji: '⭐', name: 'Star Fruit', rarity: 'legendary', chance: 0.02 },
  { id: 'moon-fruit', emoji: '🌙', name: 'Moon Fruit', rarity: 'legendary', chance: 0.015 },
  { id: 'sun-fruit', emoji: '☀️', name: 'Sun Fruit', rarity: 'legendary', chance: 0.01 },
  { id: 'rainbow-fruit', emoji: '🌈', name: 'Rainbow Fruit', rarity: 'legendary', chance: 0.005 },
  { id: 'crystal-fruit', emoji: '💠', name: 'Crystal Fruit', rarity: 'legendary', chance: 0.008 },
  { id: 'cosmic-fruit', emoji: '🌌', name: 'Cosmic Fruit', rarity: 'legendary', chance: 0.003 },
  { id: 'void-fruit', emoji: '🕳️', name: 'Void Fruit', rarity: 'legendary', chance: 0.002 },
  { id: 'time-fruit', emoji: '⏰', name: 'Time Fruit', rarity: 'legendary', chance: 0.001 },
];
