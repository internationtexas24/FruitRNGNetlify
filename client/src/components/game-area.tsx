    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-30">
        {spawnedFruits.map((spawnedFruit) => (
          ...
          >
            <div
              className={`bg-card border-2 rarity-${spawnedFruit.fruit.rarity} rounded-lg p-3 animate-fruit-spawn z-40`}
            >
              <div className="text-center">
                <div className="text-4xl mb-2">{spawnedFruit.fruit.emoji}</div>
                <div
                  className={`text-sm font-bold text-${getRarityColor(spawnedFruit.fruit.rarity)}`}
                >
